          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  "Escolha o plano ideal para gerir os seus alunos e vender os seus treinos na plataforma.",
                  textAlign: TextAlign.center,
                ...
                _buildCardPlano(
                  ...
                  beneficios: [
                    "Até 3 alunos ativos",
                    "Criar e aplicar treinos",
                    "Acesso à biblioteca padrão",
                  ],
                ...
                Stack(
                  ...
                  children: [
                    _buildCardPlano(
                      ...
                      onPressed: isPremium
                          ? null
                          : () => _abrirCheckout("Mestre Sankofa", 49.90),
                    ),
                    if (!isPremium)
                      Positioned(
                        top: -15,
  ...
  Widget _buildCardPlano({
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: isAtivo ? corDestaque : Colors.white10,
          width: isAtivo ? 2 : 1,
        ),
        boxShadow: isAtivo
            ? [
...
class _CheckoutSheetState extends State<CheckoutSheet> {
  ...
  Future<void> _gerarPix() async {
    ...
    try {
      ...
      final response = await callable.call({'productId': widget.productId});
    ...
    try {
      ...
      if (result.data['status'] == 'approved' ||
        ...
        if (mounted) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text("Pagamento aprovado! O seu plano foi ativado."),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Text(
            "${widget.planoNome} - R\$ ${widget.preco.toStringAsFixed(2)}",
