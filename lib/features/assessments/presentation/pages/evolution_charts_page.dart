...
class _EvolutionChartsPageState extends State<EvolutionChartsPage>
  ...
  late final AssessmentsRepository _assessmentsRepository;
  ...
  void initState() {
    ...
    _assessmentsRepository =
        widget.assessmentsRepository ?? FirebaseAssessmentsRepository();
    ...
    try {
      ...
      for (final record in history) {
        for (final exercise in record.exercicios) {
          if (exercise.nome.trim().isNotEmpty &&
      ...
      debugPrint('Erro ao carregar exercícios do histórico: $error');
    }
  }
      ...
      children: [
        ...
        Expanded(
          child: StreamBuilder<List<PhysicalAssessment>>(
            stream: _assessmentsRepository.watchAssessments(
              widget.studentId,
              descending: false,
            ),
            builder: (context, snapshot) {
              ...
              for (var i = 0; i < assessments.length; i++) {
                ...
                datasFormatadas.add(
                  DateFormat('dd/MM', 'pt_BR').format(assessment.date),
                );

                final value = assessment.numberValue(_medidaSelecionada);
        ...
        Expanded(
          child: StreamBuilder<List<WorkoutHistory>>(
            ...
            builder: (context, snapshot) {
              ...
              final history = <WorkoutHistory>[...?snapshot.data]
                ..sort(
