...
import '../../../workouts/presentation/pages/weekly_plan_page.dart';
  ...
  Widget _buildHeader() {
    return Container(
      ...
      child: StreamBuilder<StudentProfile?>(
        stream: _studentsRepository.watchStudentProfile(widget.studentId),
        builder: (context, snapshot) {
          final profile = snapshot.data;
          final idade = _calcularIdade(profile?.birthDate);
          final genero = profile?.gender ?? 'Não informado';
  ...
  void _confirmarDesvinculo() {
    ...
    showDialog<void>(
      ...
      builder: (dialogContext) => AlertDialog(
        ...
        content: Text(
          'Deseja remover ${widget.studentName}? Ele não verá mais seus treinos.',
        ...
        actions: [
          ...
          TextButton(
            onPressed: () async {
              try {
                await _studentsRepository.unlinkStudent(
                  studentId: widget.studentId,
                );
                ...
                messenger.showSnackBar(
                  const SnackBar(
                    content: Text('Aluno desvinculado.'),
